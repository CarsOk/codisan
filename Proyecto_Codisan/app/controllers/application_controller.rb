class ApplicationController < ActionController::Base
 ...
 private
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.permit(:sign_up, keys: [:type_document, :document, :first_name, :second_name, :first_last_name, :second_last_name, :phone_number, :email, :avatar])
